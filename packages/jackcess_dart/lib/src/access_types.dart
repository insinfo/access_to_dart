...
enum AccessObjectType {
  ...
  static AccessObjectType fromTypeValue(int typeValue) {
    switch (typeValue) {
      case 1:  return AccessObjectType.table;
      case 4:  return AccessObjectType.linkedOdbcTable;
      case 5:  return AccessObjectType.query;
      case 6:  return AccessObjectType.linkedTable;
      case 8:  return AccessObjectType.relationship;
      case -32768: return AccessObjectType.form;
      case -32764: return AccessObjectType.report;
      case -32766: return AccessObjectType.macro;
      case -32757: return AccessObjectType.module;
      case 3:  return AccessObjectType.container;
      case 2:  return AccessObjectType.group;
      default: return AccessObjectType.unknown;
    }
  }
  ...
  String get jsonLabel {
    switch (this) {
      ...
      case linkedOdbcTable:return 'linked_odbc_table';
      case query:          return 'query';
      case linkedTable:    return 'linked_table';
...
class AccessColumnSchema {
  ...
  static String typeCodeToName(int code) {
    switch (code) {
      ...
      case 0x12: return 'ComplexType';
      case 0x13: return 'BigInt';
      default:   return 'Unknown(0x${code.toRadixString(16)})';
    }
  }
  ...
  static String typeCodeToPostgres(int code, int length) {
    switch (code) {
      ...
      case 0x03: return 'SMALLINT';
      case 0x04: return 'INTEGER';
      case 0x05: return 'NUMERIC(19, 4)';
      case 0x06: return 'REAL';
      case 0x07: return 'DOUBLE PRECISION';
      case 0x08: return 'TIMESTAMP';
      case 0x09: return 'BYTEA';
      case 0x0A: return length > 0 ? 'VARCHAR(${length ~/ 2})' : 'TEXT';
      case 0x0B: return 'BYTEA';
      case 0x0C: return 'TEXT';
      case 0x0F: return 'UUID';
      case 0x10: return 'NUMERIC';
      case 0x12: return 'INTEGER';
      case 0x13: return 'BIGINT';
      default:   return 'TEXT';
    }
  }
  ...
  static String typeCodeToDart(int code) {
    switch (code) {
      ...
      case 0x07: return 'double';
      case 0x08: return 'DateTime';
      case 0x09: return 'Uint8List';
      case 0x0A: return 'String';
      case 0x0B: return 'Uint8List';
      case 0x0C: return 'String';
      case 0x0F: return 'String';
      case 0x10: return 'double';
      case 0x12: return 'int';
      case 0x13: return 'int';
