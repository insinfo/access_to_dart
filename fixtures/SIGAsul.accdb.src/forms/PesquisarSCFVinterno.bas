        ...
        Begin Section
            ...
            Begin
                ...
                Begin ListBox
                    ...
                    RowSource ="SELECT TbOfSocioEduDetalhe.CodOfSEDet, TbPessoa.Nome, TbPessoa.DNasc, TbOfSocioE"
                        "duDetalhe.DataDesl AS [DESL OFICINA], TbPessoa.DataDesligPes AS [DESLIG COMPOS] "
                        "FROM TbPessoa INNER JOIN TbOfSocioEduDetalhe ON TbPessoa.CodPessoa = TbOfSocioEd"
                        "uDetalhe.Nome WHERE (((TbPessoa.Nome) Like \"*\" & [Formulários]![PesquisarSCFVi"
                        "nterno].[TxtNome] & \"*\")) ORDER BY TbPessoa.Nome; "
                    ColumnWidths ="1134;3969;1701;1701;1701"
