        ...
        Begin Section
            ...
            Begin
                Begin TextBox
                    ...
                    Begin
                        Begin Label
                            ...
                            ForeColor =8355711
                            Name ="Rótulo1"
                            Caption ="CONSULTAR NOME DO USUÁRIO: "
                            GridlineColor =10921638
                ...
                Begin ListBox
                    ...
                    RowSource ="SELECT TbSelecaoBenefMunic.IdSelecao, TbSelecaoBenefMunic.DataSelecao, TbPessoa."
                        "NOME, TbPessoa.CodFam FROM TbPessoa INNER JOIN TbSelecaoBenefMunic ON TbPessoa.C"
                        "odPessoa = TbSelecaoBenefMunic.Nome WHERE (((TbPessoa.NOME) Like \"*\" & [Formul"
                        "ários]![PesquisarSeleção].[TxtNome] & \"*\")) ORDER BY TbSelecaoBenefMunic.DataS"
                        "elecao DESC; "
                    ColumnWidths ="1134;1134;3969"
