        ...
        Begin Section
            ...
            Begin
                ...
                Begin ListBox
                    ...
                    RowSource ="SELECT TbAtend.CodAtend, TbAtend.Data, TbCadFuncionario.Nome, TbPessoa.Nome FROM"
                        " TbAcaoComun, TbCadFuncionario INNER JOIN (TbPessoa INNER JOIN TbAtend ON TbPess"
                        "oa.CodPessoa = TbAtend.Nome) ON TbCadFuncionario.CodFunc = TbAtend.CodFunc WHERE"
                        " (((TbAcaoComun.[DataAcao]) Like \"*\" & [Formulários]![PesquisarAtend].[TxtNome"
                        "] & \"*\")) ORDER BY TbAtend.Data DESC; "
