        ...
        Begin Section
            ...
            Begin
                ...
                Begin ListBox
                    ...
                    RowSource ="SELECT TbAcomp.codAcomp, TbAcomp.DataIncl, TbPessoa.Nome, TbCadFuncionario.Nome,"
                        " TbAcompdet.DataDesl FROM TbPessoa INNER JOIN (TbCadFuncionario INNER JOIN (TbAc"
                        "omp INNER JOIN TbAcompdet ON TbAcomp.codAcomp = TbAcompdet.CodAcomp) ON TbCadFun"
                        "cionario.CodFunc = TbAcompdet.CodTecnico) ON TbPessoa.CodPessoa = TbAcomp.Nome W"
                        "HERE (((TbPessoa.Nome) Like \"*\" & [Formulários]![PesquisarAcphmt].[TxtNome] & "
                        "\"*\")) ORDER BY TbPessoa.Nome; "
                    ColumnWidths ="1134;1134;3969;3969;1134"
