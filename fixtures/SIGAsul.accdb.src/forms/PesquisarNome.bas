        ...
        Begin Section
            ...
            Begin
                ...
                Begin ListBox
                    ...
                    RowSource ="SELECT TbPessoa.CodFam, TbPessoa.CodPessoa, TbPessoa.DataCadPes, TbPessoa.Nome, "
                        "TbPessoa.Celular, TbPessoa.CPF, TbPessoa.DataDesligPes FROM TbPessoa WHERE ((([N"
                        "OME] & \" \" & [CPF] & \" \" & [CodFam]) Like \"*\" & [Formulários]![PesquisarNo"
                        "me].[TxtNome] & \"*\")) ORDER BY TbPessoa.Nome; "
                    ColumnWidths ="1420;1134;1420;4536;1701;2268"
