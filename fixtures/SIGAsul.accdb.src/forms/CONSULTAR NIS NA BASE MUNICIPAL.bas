        ...
        Begin Section
            ...
            Begin
                ...
                Begin ListBox
                    ...
                    RowSource ="SELECT [CADUNICO].Identificação, [CADUNICO].CODFAM, [CADUNICO].nom_pessoa, [CADU"
                        "NICO].NIS, [CADUNICO].BAIRRO, [CADUNICO].PBF FROM CADUNICO WHERE ((([BAIRRO] & \""
                        " \" & [NIS] & \" \" & [nom_pessoa]) Like \"*\" & Forms![CONSULTAR NIS NA BASE MU"
                        "NICIPAL].TxtNome & \"*\")) ORDER BY [CADUNICO].nom_pessoa; "
                    ColumnWidths ="1134;1421;3969;1701;1701;1701"
...
End
CodeBehindForm
' See "CONSULTAR NIS NA BASE MUNICIPAL.cls"
