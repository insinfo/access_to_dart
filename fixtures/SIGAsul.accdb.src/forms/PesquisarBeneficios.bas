        ...
        Begin Section
            ...
            Begin
                ...
                Begin ListBox
                    ...
                    RowSource ="SELECT TbBeneficiosMunicipais.CodBenef, TbBeneficiosMunicipais.Nome, TbPessoa.No"
                        "me FROM TbPessoa INNER JOIN TbBeneficiosMunicipais ON TbPessoa.CodPessoa = TbBen"
                        "eficiosMunicipais.Nome WHERE (((TbPessoa.Nome) Like \"*\" & [Formulários]![Pesqu"
                        "isarBeneficios].[TxtNome] & \"*\")) ORDER BY TbPessoa.Nome; "
