...
Begin Form
    ...
    Right =23880
    Bottom =12045
    OrderBy ="[atendimento total beneficiarios].[MáxDeData], [Lookup_Nome].[Nome]"
    RecSrcDt = Begin
        0x8e5e5c9c13f8e540
    End
    RecordSource ="atendimento total beneficiarios"
    Caption ="atendimento total beneficiarios"
