        ...
        Begin Section
            ...
            Begin
                ...
                Begin ListBox
                    ...
                    RowSource ="SELECT TbEncaminhamento.CODENC, TbEncaminhamento.DataEnc, TbPessoa.Nome FROM TbP"
                        "essoa INNER JOIN TbEncaminhamento ON (TbPessoa.CodPessoa = TbEncaminhamento.Nome"
                        ") AND (TbPessoa.CodPessoa = TbEncaminhamento.Nome) WHERE (((TbPessoa.Nome) Like "
                        "\"*\" & [Formulários]![PesquisarEncaminhamento].[TxtNome] & \"*\")) ORDER BY TbP"
                        "essoa.Nome; "
...
End
CodeBehindForm
' See "PesquisarEncaminhamento.cls"
