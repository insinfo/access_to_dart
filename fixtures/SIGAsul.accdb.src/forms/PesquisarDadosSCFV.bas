        ...
        Begin Section
            ...
            Begin
                ...
                Begin ListBox
                    ...
                    RowSource ="SELECT TbDadosPessoaisSCFV.CodDPscfv, TbDadosPessoaisSCFV.NomePessoa, TbDadosPes"
                        "soaisSCFV.CelularMae, TbDadosPessoaisSCFV.DNasc, Int(DateDiff(\"d\",[DNasc],Date"
                        "())/365.25) AS Idade FROM TbDadosPessoaisSCFV WHERE ((([TbDadosPessoaisSCFV].[No"
                        "me]) Like \"*\" & [Formulários]![PesquisarDadosSCFV].[TxtNome] & \"*\")) ORDER B"
                        "Y Int(DateDiff(\"d\",[DNasc],Date())/365.25); "
