Operation =1
Option =0
Where ="(((TbDemandaReprimida.[Demanda CIC 13 A 17])=Yes) AND ((TbDemandaReprimida.data)"
    "<=[DATA FINAL]) AND ((TbDemandaReprimida.[Data saída]) Is Null) AND ((TbPessoa.D"
    "ataDesligPes) Is Null))"
Begin InputTables
    Name ="TbUnidade"
    Name ="CadResidencia"
    Name ="TbPessoa"
