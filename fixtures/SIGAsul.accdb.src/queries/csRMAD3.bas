Operation =1
Option =0
Where ="(((TbAtColetivo.OfSESCFV)=Yes) AND ((TbAtColetivo.DataCol) Between [DATA INICIAL"
    "] And [DATA FINAL]) AND ((TbPessoa.DataDesligPes) Is Null Or (TbPessoa.DataDesli"
    "gPes)>[DATA FINAL])) OR (((TbAtColetivo.AtividadeSCFV)=Yes) AND ((TbAtColetivo.D"
    "ataCol) Between [DATA INICIAL] And [DATA FINAL]) AND ((TbPessoa.DataDesligPes) I"
