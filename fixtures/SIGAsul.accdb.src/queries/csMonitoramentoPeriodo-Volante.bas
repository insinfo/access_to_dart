Operation =1
Option =1
Where ="(((TbEncaminhamento.Volante)=Yes) AND ((TbEncaminhamento.DataEnc) Between [DATA "
    "INICIAL] And [DATA FINAL]) AND ((TbCadFuncionario.Nome) Like \"*\"+[DIGITE O NOM"
    "E DO TÉCNICO]+\"*\"))"
Begin InputTables
    Name ="TbUnidade"
    Name ="TbPessoa"
...
End
Begin OutputColumns
    Expression ="TbEncaminhamento.Volante"
