Operation =1
Option =0
Where ="(((TbBenfMunDet.[Ano de referencia])=[DIGITE O ANO]) AND ((TbCadFuncionario.Nome"
    ") Like \"*\"+[DIGITE O TÉCNICO]+\"*\") AND ((TbBenfMunDet.[Situação Beneficio])="
    "\"ATIVO\"))"
Begin InputTables
...
Begin Joins
    ...
    Expression ="TbBeneficiosMunicipais.CodFunc = TbCadFuncionario.CodFunc"
    Flag =1
End
